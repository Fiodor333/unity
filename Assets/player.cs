...
public class player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        angle = Mathf.Clamp(maxAngle - mouseInput.y * mouseY * Time.deltaTime, minAngle, maxAngle);
        cameraTransform.localRotation = Quaternion.Euler(0, 0, 0);
    }
    private void FixedUpdate()
    {
        var motionInput = cameraTransform.rotation * new Vector3(Input.GetAxis("Horizontal"), 0, Input.GetAxis("Vertical"));
